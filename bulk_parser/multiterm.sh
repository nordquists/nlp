...
bash ./nlp/bulk_parser/term $1 $6 $5 "l4_l3"    "l3"    &
bash ./nlp/bulk_parser/term $1 $6 $4 "l4_l2"    "l2"    &
bash ./nlp/bulk_parser/term $1 $6 $3 "l4_l1"    "l1"    &
bash ./nlp/bulk_parser/term $1 $6 $2 "l4_base"  "base"  &
wait